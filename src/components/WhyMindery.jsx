...
const WhyMindery = () => {
  return (
    <div className="my-16 px-4">
      ...
      {/* Cards */}
      <div className="flex flex-col md:flex-row justify-center items-stretch md:items-center gap-6 mt-8">
        <div className="w-full md:w-96 border-1 border-gray-100 p-8 rounded-md border-2">
