    ...
    <div className="navbar bg-base-100 container mx-auto px-4">
      <div className="navbar-start">
        ...
        <div className='flex items-center'>
          <img className='w-20 mr-2' src="https://i.postimg.cc/0jtm8yvk/reallogo.png" alt="Topmind Care Logo" />
          <a className="text-2xl font-semibold">Topmind Care</a>
        </div>
      </div>
      <div className="navbar-end flex-1 justify-end hidden lg:flex">
        ...
        <a className="btn primary-bg shadow-md rounded-md text-white ml-4">Start Free</a>
      </div>
    </div>
    </>
  );
